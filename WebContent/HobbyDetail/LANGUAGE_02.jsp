...
<body class="homepage is-preload">
       ...
       <div id="my-Sidebar">
         ...
         <section id="main"> 
         	<div class="container">
				...
				<h2>번역본 그만! 원어로 소설 읽기 초급반</h2>
				
				<!--class="image featured">-->
				<a><img width= 800px height= 600px src="/assets/css/images/LANGUAGE_02.jpg" alt=""/></a>
				<br>
				<h3 class="classExplanation">동화책으로 시작해서 장편소설까지, 이젠 원어로 소설 읽어요~</h3>
				<hr>
				<h3>클래스 정보</h3>
				<text>
					난이도 : 중<br>
				...
				<text>
					01. 강의소개, 준비물 소개<br>
					02. 동화책으로 영어 읽기에 익숙해지기<br>
					03. 청소년 문학으로 시작하는 긴 호흡의 영어 읽기<br>
					04. 원하는 소설을 원어로 도전하기<br>
					05. 관용 표현으로 더 깊게 읽는 원어 소설<br>
				</text>
				<hr>
				<h3>이 클래스를 완강하면,</h3>
				<text>
					원어 소설을 막힘없이 읽고 이해할 수 있어요.<br>
					소설을 통해 문화와 관용 표현을 자연스럽게 접할 수 있어요.<hr>
				</text>
				<% if(entry_yn!="Y"){%>
					<form id="getclass" method="post" action="/HobbyDetail/myClassPro.jsp" name="myClass">
						...
						<input type="hidden" name="class_id" value="LANGUAGE_02">
  ...
  <script>
	   ...
	   $('#playBtn').click( function() {
		    window.open("https://www.youtube.com/watch?v=0a34l9uKLuQ&t=840s", "유튜브", "width=800, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
	   } );
   </script>
</html>