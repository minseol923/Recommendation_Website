...
<body class="homepage is-preload">
       ...
       <div id="my-Sidebar">
         ...
         <section id="main"> 
         	<div class="container">
				...
				<h2>[한곡 마스터] 기타로 배우는 '아로하'</h2>
				
				<!--class="image featured">-->
				<a><img width= 800px height= 600px src="/assets/css/images/MUSIC_01.jpg" alt=""/></a>
				<br>
				<h3 class="classExplanation">감성 가득 '아로하'를 기타로 연주해봐요</h3>
				<hr>
				<h3>클래스 정보</h3>
				<text>
					난이도 : 하 ~ 중<br>
				...
				<text>
					01. 강의소개, 준비물 소개<br>
					02. '아로하' 연주에 필요한 코드 배우기<br>
					03. 코드 자연스럽게 연결하여 연주하기<br>
				</text>
				<hr>
				<h3>이 클래스를 완강하면,</h3>
				<text>
					기타를 처음 접할 때, 쉬운 코드로 곡을 완주하며 기타에 재미를 붙일 수 있어요.<br>
					간단한 코드와 코드를 이어 연주하는 연습을 할 수 있어요.<hr>
				</text>
				<% if(entry_yn!="Y"){%>
					<form id="getclass" method="post" action="/HobbyDetail/myClassPro.jsp" name="myClass">
						...
						<input type="hidden" name="class_id" value="MUSIC_01">
  ...
  <script>
	   ...
	   $('#playBtn').click( function() {
		    window.open("https://www.youtube.com/watch?v=Ni8TInnyjQo", "유튜브", "width=800, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
	   } );
   </script>
</html>