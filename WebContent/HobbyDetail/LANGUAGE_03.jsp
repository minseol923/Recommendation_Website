...
<body class="homepage is-preload">
       ...
       <div id="my-Sidebar">
         ...
         <section id="main"> 
         	<div class="container">
				...
				<h2>'언어 학습의 정석' 사전으로 단어 마스터하기</h2>
				
				<!--class="image featured">-->
				<a><img width= 800px height= 600px src="/assets/css/images/LANGUAGE_03.jpg" alt=""/></a>
				<br>
				<h3 class="classExplanation">사전과 함께 정석으로 어휘를 마스터해요</h3>
				<hr>
				<h3>클래스 정보</h3>
				<text>
					난이도 : 중<br>
				...
				<text>
					01. 강의소개, 준비물 소개<br>
					02. 사전을 통한 어휘 공부의 강점<br>
					03. 예문으로 단어 머릿속에 새기기<br>
					04. 반의어 유의어 개념을 통해 빠르게 단어 마인드맵 확장하기<br>
					05. 나만의 사전으로 어휘 마스터하기<br>
				</text>
				<hr>
				<h3>이 클래스를 완강하면,</h3>
				<text>
					막막함을 느끼던 단어공부의 벽을 넘을 수 있어요.<br>
					풍부한 단어를 습득해 영어를 더 폭 넓게 사용할 수 있어요.<hr>
				</text>
				<% if(entry_yn!="Y"){%>
					<form id="getclass" method="post" action="/HobbyDetail/myClassPro.jsp" name="myClass">
						...
						<input type="hidden" name="class_id" value="LANGUAGE_03">
  ...
  <script>
	   ...
	   $('#playBtn').click( function() {
		    window.open("https://www.youtube.com/watch?v=t5i_Eg98iZ0", "유튜브", "width=800, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
	   } );
   </script>
</html>