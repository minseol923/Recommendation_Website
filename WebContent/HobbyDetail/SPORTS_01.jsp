...
<body class="homepage is-preload">
       ...
       <div id="my-Sidebar">
         ...
         <section id="main"> 
         	<div class="container">
				...
				<h2>요가로 몸과 마음 바로잡기</h2>
				
				<!--class="image featured">-->
				<a><img width= 800px height= 600px src="/assets/css/images/SPORTS_01.jpg" alt=""/></a>
				<br>
				<h3 class="classExplanation">몸과 마음의 균형을 잡을 수 있는 요가 운동을 해봅시다.</h3>
				<hr>
				<h3>클래스 정보</h3>
				<text>
					난이도 : 중<br>
				...
				<text>
					01. 강의소개, 준비물 소개<br>
					02. 일반요가 (힐링, 아쉬탕가,빈야사)<br>
					03. 핫 요가<br>
					04. 플라잉 요가<br>
					05. 요가 고수의 추천 프로그램<br>
				<hr>
				<h3>이 클래스를 완강하면,</h3>
				<text>
					몸의 균형과 유연성을 키울 수 있어요.<br>
					마음을 정화시킬 수 있어요.<br>
				</text>
				<% if(entry_yn!="Y"){%>
					<form id="getclass" method="post" action="/HobbyDetail/myClassPro.jsp" name="myClass">
						...
						<input type="hidden" name="class_id" value="SPORTS_01">
  ...
  <script>
	   ...
	   $('#playBtn').click( function() {
		    window.open("https://www.youtube.com/watch?v=iYmQjBZ04y4", "유튜브", "width=800, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
	   } );
   </script>
</html>