...
<body class="homepage is-preload">
       ...
       <div id="my-Sidebar">
         ...
         <section id="main"> 
         	<div class="container">
				...
				<h2>실과 바늘만 있다면 뭐든 만들 수 있어!</h2>
				
				<!--class="image featured">-->
				<a><img width= 800px height= 600px src="/assets/css/images/DIY_01.jpg" alt=""/></a>
				<br>
				<h3 class="classExplanation">무엇이든 만들어 내는 뜨개질 활용백서!</h3>
				<hr>
				<h3>클래스 정보</h3>
				<text>
					난이도 : 중<br>
				...
				<text>
					01. 강의소개, 준비물 소개<br>
					02. 알고보면 아주 넓은 뜨개질의 세계<br>
					03. 뜨개질의 기본! 목도리 뜨기<br>
					04. 파우치와 복주머니 뜨기<br>
					05. 레이스 무늬 뜨기<br>
					06. 에어팟 케이스부터 지갑까지 나만의 뜨개질 하기<br>
				</text>
				<hr>
				<h3>이 클래스를 완강하면,</h3>
				<text>
					뜨개질에 익숙해져 완성도높은 뜨개질을 할 수 있어요.<br>
					간단한 뜨개질부터 나만의 맞춤 뜨개질까지 뜨개질을 다양하게 활용할 수 있어요.<hr>
				</text>
				<% if(entry_yn!="Y"){%>
					<form id="getclass" method="post" action="/HobbyDetail/myClassPro.jsp" name="myClass">
						...
						<input type="hidden" name="class_id" value="DIY_01">
  ...
  <script>
	   ...
	   $('#playBtn').click( function() {
		    window.open("https://www.youtube.com/watch?v=INE_i-AfSZU", "유튜브", "width=800, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
	   } );
   </script>
</html>