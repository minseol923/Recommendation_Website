...
<body class="homepage is-preload">
       ...
       <div id="my-Sidebar">
         ...
         <section id="main"> 
         	<div class="container">
				...
				<h2>근력과 체력 향상을 위한 헬스</h2>
				
				<!--class="image featured">-->
				<a><img width= 800px height= 600px src="/assets/css/images/SPORTS_03.jpg" alt=""/></a>
				<br>
				<h3 class="classExplanation">근력과 체력을 향상시킬 수 있는 헬스를 해봅시다.</h3>
				<hr>
				<h3>클래스 정보</h3>
				<text>
					난이도 : 상<br>
				...
				<text>
					...
					05. 하체위주 운동 따라하기<br>
					06. 상체위주 운동 따라하기<br>
					07. 집에서도 할 수 있는 홈트레이닝<br>
				<hr>
				<h3>이 클래스를 완강하면,</h3>
				<text>
					하루 30분 운동만으로도 몸이 가벼워질거예요.<br>
					30분의 좋은 습관은 내 몸에 좋은 흔적을 남길 수 있어요!<br>
				</text>
				<% if(entry_yn!="Y"){%>
					<form id="getclass" method="post" action="/HobbyDetail/myClassPro.jsp" name="myClass">
						...
						<input type="hidden" name="class_id" value="SPORTS_03">
  ...
  <script>
	   ...
	   $('#playBtn').click( function() {
		    window.open("https://www.youtube.com/watch?v=zjfGs_iIIE8", "유튜브", "width=800, height=700, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
	   } );
   </script>
</html>