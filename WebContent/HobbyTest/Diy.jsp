			...
			<div class="vod-detail-row">
				<div class="detail-col-left">
					<div class="box-text">
                        ...
                        <p><strong><em class="underline">DYI</em> <span class="web_view">입니다.</span></strong></p>
				...
				<div class="detail-col-right">
					...
					<p class="vod_medium_title">
						<strong>
							취미계의 트렌드!	
						</strong>
					</p>
					<p class="vod_small_title">
						<strong>코로나19 극복, 집에서 D.I.Y(Do It Yourself)</strong>
					</p>
					<div class="img_area">
						<img src="/images/d6.jpg" alt="">
					</div>
					<p class="text_detail">
						대학 강의가 보류되고 많은 근로자들이 임시 해고된 상황에서, 젊은이들이 시간을 보내기 위한 방법으로 처음으로 DIY를 시도할 가능성이 높다.<br> 한 조사에 따르면, 18세에서 24세 응답자 중 50%는 시간이 충분하여, 30%는 금전적 여유가 생겨서, 25%는 변화를 위하여 DIY를 처음으로 시도한다고 응답하였다. 흥미로운 점은, 젊은이들은 여전히 환경 문제를 고려하고 있으며 응답자의 60%는 구매 전에 여전히 제품의 지속 가능성을 고려할 것이라는 점이다. <br>(자료: BBC 뉴스). 
					</p>
				</div>
			</div>
		</section>
