...
action="/ServiceCenter/Noticeboard/notice_updatePro.jsp?pageNum=<%=pageNum%>" onsubmit="return writeSave()">
<table border="1">
  <tr>
  ...
  <tr>      
   <td colspan=2  align="center"> 
     ...
     <input type="button" value="목록보기" 
       onclick="document.location.href='/ServiceCenter/Noticeboard/notice.jsp?pageNum=<%=pageNum%>'">
   </td>
 </tr>
 </table>
</form>
